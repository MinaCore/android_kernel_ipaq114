...
static int power_suspend_noirq(struct device *dev)
{
...
static struct dev_pm_ops wakelock_dev_pm_ops = {
	.suspend_noirq = power_suspend_noirq,
};

static struct platform_driver power_driver = {
	.driver.name = "power",
	.driver.pm   = &wakelock_dev_pm_ops
};
